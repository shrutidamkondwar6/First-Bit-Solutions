...
class WasteManagement extends CityService// sub class 1
{
	...
	public String getArea_coverd() {
		return area_coverd;
	}

	public void setArea_coverd(String area_coverd) {
		this.area_coverd = area_coverd;
	}
...
class WaterSupply extends CityService// sub class 2
{
	...
	public int getHouse_holds_served() {
...
class DemoCityService
{
	 static void main(String[] args) {
		...
		WasteManagement w1=new WasteManagement();
		w1.display();
		
		WaterSupply water1=new WaterSupply();
		water1.display();
		
		ElectricityDepartment e1=new ElectricityDepartment();
		e1.display();
	}
}
